...
// to get the stuff that's attached to it (traverse)
...
//////////// Remember this tag for the homework 

// // create the new html tag 
// let newLi = document.createElement('li')
// // add the text for the new html tag 
// newLi.innerHTML = "item 2"
// // select the area to attach the tag
// let list = document.querySelector('ul')
// // add the tag to the selected parent tag 
